...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative flex min-h-[calc(100vh-64px)] items-center overflow-hidden bg-white max-[760px]:min-h-0 max-[760px]:flex-col-reverse"
    >
      <div
        className="absolute top-0 right-0 bottom-0 w-[clamp(280px,44vw,720px)] animate-[zafFade_1.1s_var(--ease-zaf)_0.15s_both] [clip-path:polygon(clamp(48px,8vw,132px)_0,100%_0,100%_100%,0_100%)] max-[760px]:relative! max-[760px]:h-[62vh] max-[760px]:w-full! max-[760px]:[clip-path:polygon(0_9vw,100%_0,100%_100%,0_100%)]!"
      >
        <Image
      ...
      <div className="relative z-[2] w-full p-[clamp(40px,6vw,96px)_clamp(20px,4vw,56px)] max-[760px]:px-5 max-[760px]:pt-9 max-[760px]:pb-16">
        <h1 className="m-0">
          <Image
        ...
        <p className="m-0 mb-[18px] animate-[zafUp_0.8s_var(--ease-zaf)_0.3s_both] text-[clamp(14px,1.3vw,17px)] font-semibold tracking-[0.22em] text-ink">
          {hero.tagline}
        </p>
