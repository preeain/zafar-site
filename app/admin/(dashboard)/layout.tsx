    ...
    <div className="admin-shell min-h-screen bg-[#f3f1ed] text-ink">
      <header className="sticky top-0 z-50 border-b border-ink bg-white/95 backdrop-blur">
        <div className="mx-auto flex min-h-16 max-w-[1500px] items-center justify-between gap-5 px-5 sm:px-8">
          ...
          <div className="flex items-center gap-4">
            <nav aria-label="Admin sections" className="hidden items-center gap-4 lg:flex"><Link href="/admin" className="min-h-11 content-center text-xs font-semibold tracking-[.12em]">CONTENT</Link><Link href="/admin/history" className="min-h-11 content-center text-xs font-semibold tracking-[.12em]">HISTORY</Link><Link href="/admin/media" className="min-h-11 content-center text-xs font-semibold tracking-[.12em]">MEDIA</Link><Link href="/admin/audience" className="min-h-11 content-center text-xs font-semibold tracking-[.12em]">AUDIENCE</Link></nav>
        ...
        <nav aria-label="Admin sections" className="mx-auto flex max-w-[1500px] overflow-x-auto border-t border-ink/15 px-5 lg:hidden"><Link href="/admin" className="min-h-11 content-center pr-6 text-[10px] font-semibold tracking-[.14em]">CONTENT</Link><Link href="/admin/history" className="min-h-11 content-center pr-6 text-[10px] font-semibold tracking-[.14em]">HISTORY</Link><Link href="/admin/media" className="min-h-11 content-center pr-6 text-[10px] font-semibold tracking-[.14em]">MEDIA</Link><Link href="/admin/audience" className="min-h-11 content-center pr-6 text-[10px] font-semibold tracking-[.14em]">AUDIENCE</Link></nav>
      </header>
